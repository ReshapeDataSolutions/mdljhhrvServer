...
#' @examples
#' salaryServer()
salaryServer <- function(input,output,session,dms_token) {
  ...
  shiny::observeEvent(input$btn_salary,{
    token=dms_token
    ...
    jhhrvvoucherpkg::stdsalary(token = token,FYear =FYear ,FMonth =FMonth ,FExpenseOrgID =FExpenseOrgID )
    
    
    
    jhhrvvoucherpkg::srcsalary(token = token,FYear =FYear ,FMonth =FMonth ,FExpenseOrgID =FExpenseOrgID )
    
    
    jhhrvvoucherpkg::odssalary(token = token,FYear =FYear ,FMonth =FMonth ,FExpenseOrgID =FExpenseOrgID )
